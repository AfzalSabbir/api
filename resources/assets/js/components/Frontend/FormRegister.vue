<template>
	<div>
    <!-- form -->
    <form class="auth-form need-validation" @submit.prevent="submit()" method="POST" :action="url_register" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <div class="form-label-group has-spinner">
          <input type="mobile" id="inputMobile" v-model='model_mobile' name='mobile' class="form-control" placeholder="Mobile" required=""> <label for="inputMobile">{{ lang.mobile }}</label>
        </div>
      </div><!-- /.form-group -->
      <!-- .form-group -->
      <div class="form-group">
