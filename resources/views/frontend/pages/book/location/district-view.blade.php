...
@section('fav_title', check_lang('bn') ? $district->bn_name:$district->name)
    ...
    <div class="row">
      <div class="col-lg-9">
        ...
        <div class="list-group-bordered list-group-reflow border-primary bg-white box-shadow mb-3">
          <span id="district-toggle" class="col-12 list-group-item justify-content-between align-items-center border-0 bg-primary text-white rounded-0 font-weight-bold cursor-pointer" title="{{ !$locations->isEmpty() ? 'Show/Hide Upazila':'Empty' }}">
            {{ check_lang('bn') ? $district->bn_name:$district->name }}
                ...
                <figure class="figure">
                  ...
                  <div class="figure-img text-center">
                    ...
                    <div class="figure-description text-left pt-2 px-0">
                      <h6 class="figure-title"><i class="oi oi-book _oi mr-1"></i> {{ $element->title }}</h6>
                      <p class="mb-0">
