...
@section('fav_title', __('backend/default.cookies_policy'))
...
<div class="page-inner pt-2 pb-0">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <h1>Cookie Policy for BoiNaw</h1>

        <p>This is the Cookie Policy for BoiNaw, accessible from {{ env('APP_URL') }}</p>
