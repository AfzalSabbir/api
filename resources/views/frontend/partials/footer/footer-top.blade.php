        ...
        <div class="container">
          ...
          <div class="card bg-success text-white position-relative overflow-hidden shadow rounded-lg p-4 mb-0 aos-init aos-animate" data-aos="fade-up">
            ...
            <div class="card-body d-md-flex justify-content-between align-items-center text-center position-relative">
              <h3 class="font-weight-normal mb-3 mb-md-0 mr-md-3"> {{ __('backend/default.got_a_question_about_boinaw') }}? </h3><a class="btn btn-lg btn-primary shadow" href="{{ route('contact_us') }}">{{ __('backend/default.contact_us') }} <i class="fad fa-angle-right ml-2"></i></a>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
        </div><!-- /.container -->
      </section>