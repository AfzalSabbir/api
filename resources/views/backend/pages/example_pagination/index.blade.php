...
@section('fav_title', __('backend/example_pagination.example_pagination') )
...
<div class="app-title">
	...
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item active">{{ __('backend/example_pagination.example_pagination') }}</li>
	</ul>
</div>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-table' }}"></i> {{ __('backend/example_pagination.example_pagination_list') }}</h2></div>
