...
@section('fav_title', __('backend/example.edit_example') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-pencil-square' }}"></i> {{ __('backend/example.edit_example') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{-- route('admin.example.update',$row->id) --}}" method="post" enctype="multipart/form-data">
					@csrf
