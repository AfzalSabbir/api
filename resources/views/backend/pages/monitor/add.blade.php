...
@section('fav_title', __('backend/monitor.add_monitor') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6 my-auto"><h2><i class="{{ 'fa fa-plus-square' }}"></i> {{ __('backend/monitor.add_monitor') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{-- route('admin.monitor.store') --}}" method="post" enctype="multipart/form-data">
					@csrf
