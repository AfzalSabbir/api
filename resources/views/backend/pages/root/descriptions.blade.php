<div class="col-sm-12 pt-1 br-4" style="height: 100%; background-color: #e5e5e5; width: 100%;">
	...
	<span class="detail_">
		...
		<span class="description_container" style="display: none;">
			<ul class="pl-3 mb-0">
				<li>Add <a href="{{ route('admin.menu.create') }}"><code>Sidebar Menu</code></a> and Give Access Permission to <a href="{{ route('admin.role.assign.super_admin') }}"><code>SuperAdmin</code></a>.</li>
		...
		<span class="description_makeController" style="display: none;">
			<ul class="pl-3 mb-0">
				<li><code class="text-default">Yes/No</code> Choose Wisely.<br>If <code>Yes</code>, be sure that <code>Backend\<span class="getFileName font-weight-bold text-underline-wavy">[...]</span>Controller.php</code> does not exists already!</li>
			</ul>
		</span>
		...
		<span class="description_makeModel" style="display: none;">
			<ul class="pl-3 mb-0">
				<li><code class="text-default">Yes/No</code> Choose Wisely.<br>If <code>Yes</code>, be sure that <code>Models\<span class="getFileName font-weight-bold text-underline-wavy">[...]</span>.php</code> does not exists already!</li>
			</ul>
		</span>
	</span>
</div>