...
@section('fav_title', __('backend/default..env') )
		...
		<div class="card">
			...
			<div class="card-body p-0">
				...
				<form class="form-horizontal" action="{{ route('admin.env.save', $save_token) }}" method="post" enctype="multipart/form-data">
					...
					<pre><textarea spellcheck="false" name="insert" rows="{{ $rows+3 }}" class="insert form-control rounded-0 border-0" id="insert">{{ $env }}</textarea></pre>
